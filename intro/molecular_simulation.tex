...
phenomena.%\footnotemark{}

%\footnotetext{
%% Though such methods will not feature in the present work, we would be remiss
%% not to also mention the \mc technique, an equally important
%% and commonly-used way of solving \cref{eq:intro-boltzmann} in cases where only
%% thermodynamic properties are of concern.
