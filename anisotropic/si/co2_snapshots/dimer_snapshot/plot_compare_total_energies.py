...
parser.add_argument("-p","--prefixes", help="prefixes", nargs="*", default=['mastiff_'])
...
fig.text(0.5,0.035, 'Kalugina PES Energy (kJ/mol)',ha='center',
        va='center',
        fontweight='semibold',
        fontsize=24)
...
first=True
labels = []
label_texts = itertools.cycle(['2b Energies','Aniso-Iso FF','Aniso-Aniso FF'])
...
if args.asymptotic:
    ...
    outtitle = 'co2_dimer_comparison.pdf'
