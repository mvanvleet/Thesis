...
#mastiff_file = '01_mastiff_nh3/mastiff_virials.dat'
...
fig.savefig('nh3_2nd_virial.pdf',bbox_inches='tight',dpi=200)
#fig.savefig('nh3_2nd_virial.png',bbox_inches='tight')
#plt.show()
