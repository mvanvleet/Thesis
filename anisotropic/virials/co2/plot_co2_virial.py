...
#mastiff_file = '01_mastiff_co2/mastiff_virials.dat'
...
exp1_data['B'] *= 1000 # units for this file in L/mol, not cm^3/mol
...
fig.savefig('co2_2nd_virial.pdf',bbox_inches='tight',dpi=200)
#fig.savefig('co2_2nd_virial.png',bbox_inches='tight')
#plt.show()
