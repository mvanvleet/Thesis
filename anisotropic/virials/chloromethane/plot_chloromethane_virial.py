...
exp1_file = 'experimental_virials.dat'
#exp2_file = 'hamann_pearse_experimental_virials.dat'
#exp2_file = 'hirschfelder_experimental_virials.dat'
exp2_file = 'bottomly_experimental_virials.dat'

#mastiff_file = '01_mastiff_chloromethane/mastiff_virials.dat'
...
f = experimental_eos
for line in ((f(x) - y)/f(x)*100):
    print line
print '----'
print np.average((f(x) - y)/f(x)*100)
...
##         's',
##         color='k',
##         label='Bottomley et al.',
##         linewidth=1.4*mew,
##         zorder=10
##         )

# This paper SAPT-FF data
x = isaff_data['T']
y = isaff_data['B']
ax.plot(x,y,
        's',
...
fig.savefig('chloromethane_2nd_virial.pdf',bbox_inches='tight',dpi=200)
#fig.savefig('chloromethane_2nd_virial.png',bbox_inches='tight')
#plt.show()
